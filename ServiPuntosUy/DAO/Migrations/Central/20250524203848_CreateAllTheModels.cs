...
{
    /// <inheritdoc />
    public partial class CreateAllTheModels : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccumulationRule = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ExpiricyPolicyDays = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LoyaltyConfigs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LoyaltyConfigs_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantUIs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TenantUIs_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FuelPrices_Branches_BranchId",
                        column: x => x.BranchId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SatisfactionSurveys_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceAvailabilities_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Redemptions_Tenants_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "admin@servipuntos.uy", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Admin Central", true, "eqfEMwjIhFvPikVt0rT11HRRtPA3z+ZLlI6lm82Hb/M=", "wtVAt8oceNJozzjPC/D/sw==", 0, 1, null },
                    { 2, null, "admintenant@servipuntos.uy", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Admin Tenant", true, "eqfEMwjIhFvPikVt0rT11HRRtPA3z+ZLlI6lm82Hb/M=", "wtVAt8oceNJozzjPC/D/sw==", 0, 2, 1 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FuelPrices_BranchId",
                table: "FuelPrices",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_LoyaltyConfigs_TenantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SatisfactionSurveys_BranchId",
                table: "SatisfactionSurveys",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceAvailabilities_BranchId",
